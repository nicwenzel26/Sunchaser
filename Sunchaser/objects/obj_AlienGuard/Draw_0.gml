//If the room is a combat room then draw their health above their head
if(room == CombatRoom || room ==CombatRoom_Landed) {
	...
	//If the user has them selected then draw the selected sprite behind them
	if(selected) {
...
//Always draw sprite assinged to the object
else {
	draw_self()
}