if(close && !done_talking) {
	...
	draw_text(global.text_offset, gui_height -100, " - I don't have time for this (Attack) [1]")
	draw_text(global.text_offset, gui_height -80, " - Me and my crew have been sent to kill you, what do you have to say for yourself. [2]")
